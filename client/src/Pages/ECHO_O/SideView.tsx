...
const SideView: React.FC<SideViewProps> = ({
  ...
  return (
    <div
      className={`relative -left-2 -top-5 bottom-0 ${isDockOpen ? "min-h-[94vh]" : "min-h-[99.5vh]"}  min-w-sm flex flex-col gap-1.5 p-4 overflow-y-auto scrollbar-hide origin-top `}
    >
      {/* Info */}
      <div
