...
const LandingPage = () => {
  ...
  return (
    <div>
      <div className="min-h-screen bg-linear-to-br from-amber-50 via-orange-100 to-rose-100 text-slate-900 overflow-x-hidden relative">
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                <img
                  ...
                  className="w-10 h-10 box-border border-1 border-black rounded-full"
                />
                <span className="tracking-wider text-white">CALDERA</span>
              </motion.div>
          ...
          <section className="px-8 py-20 relative">
            <div className="max-w-7xl mx-auto">
              <motion.div
                ...
                transition={{ duration: 0.6 }}
              >
                <h2 className="mb-4 text-slate-100">The Four Pillars</h2>
                <p className="text-slate-100 max-w-2xl mx-auto">
                  Four powerful tools, perfectly integrated. Move seamlessly
                  from brainstorm to execution without ever leaving your
                  workspace.
                </p>
              </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <p className="text-slate-600 mb-4">
                    ...
                    timelines. Links directly to the editor so tasks can be born
                    from documents.
                  </p>
                  <div className="flex flex-wrap gap-2">
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <motion.div
                  ...
                  whileHover={{ scale: 1.05, y: -5 }}
                >
                  <BsActivity className="w-10 h-10 mb-4 text-orange-400" />
            ...
            >
              <div className="flex items-center gap-2">
                <img
                  ...
                  className="w-10 h-10 border rounded-full border-black box-border"
                />
